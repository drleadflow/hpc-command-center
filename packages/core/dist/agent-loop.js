...
function isStuckLoop(history, threshold) {
...
export async function runAgentLoop(options) {
    const { systemPrompt, tools, context, maxIterations = DEFAULT_MAX_ITERATIONS, costBudget = context.costBudget ?? 0, streaming = false, onTurn, onToolCall, onTextDelta, onComplete, onError, } = options;
    const modelConfig = resolveModelConfig(context.modelId);
