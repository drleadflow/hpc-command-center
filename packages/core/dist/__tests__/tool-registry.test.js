...
import { registerTool, getTool, getAllToolDefinitions, executeTool, clearRegistry, createToolScope, registerScopedTool, getScopedToolDefinitions, destroyToolScope, } from '../tool-registry.js';
function makeDef(name, category = 'custom') {
    return {
        name,
...
function makeHandler(returnValue = 'ok') {
